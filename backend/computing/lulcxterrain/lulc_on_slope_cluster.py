...
from computing.lulcxterrain.utils import aez_lulcXterrain_cluster_centroids, process_mws, calculate_area


def lulc_on_slope_cluster(state, district, block, start_year, end_year):
    ...
    asset_id = get_gee_asset_path(state, district, block, "projects/ee-saharshlaud/assets/apps/mws/") + asset_description
    print("hello2")
...
#         + "_lulcXslopes_clusters"
#     )
#     asset_id = get_gee_asset_path(state, district, block, asset_path="projects/ee-corestackdev/assets/apps/mws/") + asset_description
