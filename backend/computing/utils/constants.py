...
# # MARK: GEE Paths
# GCS_BUCKET_NAME = "core_stack"  # You might want to change this to your own bucket

# # Change these paths to use your GEE project
# GEE_ASSET_PATH = "projects/ee-saharshlaud/assets/apps/mws/"
# GEE_HELPER_PATH = "projects/ee-saharshlaud/assets/apps/mws/"  # Use same as main path
