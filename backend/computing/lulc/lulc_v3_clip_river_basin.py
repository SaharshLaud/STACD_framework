...
from computing.utils.constants import GEE_PATHS

def lulc_river_basin( state, district, block, start_year, end_year):
    ...
    while loop_start < loop_end:
        ...
        final_output_assetid = (
            get_gee_asset_path(state, district, block, asset_path=GEE_PATHS['MWS']['GEE_ASSET_PATH']) +
    ...
    # Return asset IDs for Airflow to use
