...
def generate_terrain_clusters( state, district, block):
    ...
    asset_id = get_gee_asset_path(state, district, block, "projects/ee-saharshlaud/assets/apps/mws/") + asset_name
    print("hello2")
...
#     asset_id = get_gee_asset_path(state, district, block, asset_path="projects/ee-saharshlaud/assets/apps/mws/") + asset_name
...
#     dem = ee.Image("USGS/SRTMGL1_003")
#     mt1k = ee.FeatureCollection(
#         get_gee_asset_path(state, district, block, asset_path="projects/ee-saharshlaud/assets/apps/mws/")
#         + "filtered_mws_"
#         + valid_gee_text(district.lower())
#         + "_"
#         + valid_gee_text(block.lower())
